                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                        flag ? "${state.homeViewModel.data?.sellerDetails?.shopName}" : " "
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      flag ? "${state.homeViewModel.data?.sellerDetails?.shopAddress}": " ",
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.left,
                                ...
                                children: [
                                  ...
                                  Container(
                                    height: getVerticalSize(
                                     ...
                                     // color: state.homeViewModel.data!.activeServices != null ? Colors.red :Colors.green,
                                    //color: Colors.red
                                    child:
                                    state.homeViewModel.data!.activeServices!.length != 0
                                        ?
                                    ListView.separated(
                                      padding: getPadding(
                                        top: 21,
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        child: Text("No Service added",style: TextStyle(color: Colors.red),)
                                    )
