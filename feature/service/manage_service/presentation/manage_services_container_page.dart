                    ...
                    child: Padding(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            if (filterKey == 1) {
                              if (state.serviceModel.data![index].status == 1 && state.serviceModel.data![index].status != 0) {
                              ...
                              if (state.serviceModel.data![index].status == 0 && state.serviceModel.data![index].status != 1) {
                                return ListservicenameItemWidget(
                                  serviceData: state.serviceModel.data![index],
                                );
                              }
